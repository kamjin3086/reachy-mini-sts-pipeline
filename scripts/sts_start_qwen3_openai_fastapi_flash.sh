...
FASTAPI_HOME=${QWEN3_OPENAI_FASTAPI_HOME:-/tmp/sts_tuning/qwen3_openai_fastapi_flash_home}
...
export TORCHINDUCTOR_CACHE_DIR=${TORCHINDUCTOR_CACHE_DIR:-/tmp/torchinductor_${USER:-kamjin}}
...
start_fastapi() {
    ...
    echo "[fastapi] First startup can take several minutes while torch.compile warms up."
    HOME="$FASTAPI_HOME" \
